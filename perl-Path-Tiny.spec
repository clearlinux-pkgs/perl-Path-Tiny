...
Source0  : https://cpan.metacpan.org/authors/id/D/DA/DAGOLDEN/Path-Tiny-0.122.tar.gz
...
%prep
%setup -q -n Path-Tiny-0.122
cd %{_builddir}/Path-Tiny-0.122
...
cp %{_builddir}/Path-Tiny-0.122/LICENSE %{buildroot}/usr/share/package-licenses/perl-Path-Tiny/85e14080c483146fd022a7140831a977f7eeaac8
if test -f Makefile.PL; then
