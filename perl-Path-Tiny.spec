...
Source0  : https://cpan.metacpan.org/authors/id/D/DA/DAGOLDEN/Path-Tiny-0.116.tar.gz
...
%prep
%setup -q -n Path-Tiny-0.116
cd %{_builddir}/Path-Tiny-0.116
...
cp %{_builddir}/Path-Tiny-0.116/LICENSE %{buildroot}/usr/share/package-licenses/perl-Path-Tiny/5304bf21bd261ac05d4427fc4d0b971e8b2731cc
if test -f Makefile.PL; then
