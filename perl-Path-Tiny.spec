...
%prep
%setup -q -n Path-Tiny-0.112
cd %{_builddir}/Path-Tiny-0.112
...
cp %{_builddir}/Path-Tiny-0.112/LICENSE %{buildroot}/usr/share/package-licenses/perl-Path-Tiny/5304bf21bd261ac05d4427fc4d0b971e8b2731cc
if test -f Makefile.PL; then
